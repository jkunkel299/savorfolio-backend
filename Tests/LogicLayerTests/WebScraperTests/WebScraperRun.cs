...
public partial class WebScraperRun()
{
    ...
    public void RunScraperAsyncCallsFunctions()
    {
        ...
        mockWebScraperService
            .Setup(r => r.GetHtmlAsync(It.IsAny<string>()))
            .ReturnsAsync(It.IsAny<IDocument>());

        mockWebScraperService
            .Setup(r => r.SampleCssClasses(It.IsAny<IDocument>()))
            .Returns(It.IsAny<string>());

        mockWebScraperService
            .Setup(r => r.MapCssClassPatterns(It.IsAny<string>()))
            .Returns(It.IsAny<Dictionary<string, string?>?>());

        mockWebScraperService
            .Setup(r =>
                r.BuildRecipeSummary(
                    It.IsAny<IDocument>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),
        ...
        mockWebScraperService
            .Setup(r =>
                r.BuildRecipeTags(It.IsAny<IDocument>(), It.IsAny<string>(), It.IsAny<string>())
            )
            .Returns(It.IsAny<TagStringsDTO>());
        mockWebScraperService
            .Setup(r => r.BuildRecipeIngredients(It.IsAny<IDocument>(), It.IsAny<string>()))
            .Returns(It.IsAny<List<string>>());
        mockWebScraperService
            .Setup(r => r.BuildRecipeInstructions(It.IsAny<IDocument>(), It.IsAny<string>()))
        ...
        mockWebScraperService.Verify(
            f => f.SampleCssClasses(It.IsAny<IDocument>()),
            Times.AtMostOnce
        );
        // assert MapCssClassPatterns is called once
        mockWebScraperService.Verify(
            f => f.MapCssClassPatterns(It.IsAny<string>()),
            Times.AtMostOnce
        );
        // assert BuildRecipeSummary is called once
        mockWebScraperService.Verify(
            f =>
                f.BuildRecipeSummary(
                    It.IsAny<IDocument>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),
        ...
        mockWebScraperService.Verify(
            f => f.BuildRecipeTags(It.IsAny<IDocument>(), It.IsAny<string>(), It.IsAny<string>()),
            Times.AtMostOnce
        );
        // assert BuildRecipeIngredients is called once
        mockWebScraperService.Verify(
            f => f.BuildRecipeIngredients(It.IsAny<IDocument>(), It.IsAny<string>()),
            Times.AtMostOnce
        );
        // assert BuildRecipeSummary is called once
        mockWebScraperService.Verify(
            f => f.BuildRecipeInstructions(It.IsAny<IDocument>(), It.IsAny<string>()),
            Times.AtMostOnce
        );
    }
}
