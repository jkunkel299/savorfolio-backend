...
public partial class NoPatternWebScraperTests(WebScraperFixture webScraperFixture) : IClassFixture<WebScraperFixture>, IAsyncLifetime
{
    ...
    public void BuildRecipeSummary_callsFallbacks()
    {
        ...
        mockFallbackHeuristics.Setup(r => r.ExtractTitle(_document))
            .Returns(It.IsAny<string>());
        mockFallbackHeuristics.Setup(r => r.ExtractDescription(_document))
            .Returns(It.IsAny<string>());
        mockFallbackHeuristics.Setup(r => r.ExtractTimeNearLabel(_document, "prep time"))
            .Returns(It.IsAny<string>());
        mockFallbackHeuristics.Setup(r => r.ExtractTimeNearLabel(_document, "cook time"))
            .Returns(It.IsAny<string>());
        mockFallbackHeuristics.Setup(r => r.ExtractServings(_document))
            .Returns(It.IsAny<string>());
