...
public class TagsRepository(AppDbContext context) : ITagsRepository
{
    ...
    public TagStringsDTO GetTagsByRecipe(int recipeId)
    {
        ...
        var entity = _context.RecipeTags
            .FirstOrDefault(t => t.RecipeId == recipeId)
        ...
        var cuisineTag = entity.Cuisine != null
        ...
        List<DietaryTag> dietaryTags = [.. entity.Dietary
            .Select(EnumExtensions.ParseEnumMember<DietaryTag>)
            .Where(t => t.HasValue)
            .Select(t => t!.Value)];
        ...
        var result = new TagStringsDTO
        {
            ...
            Recipe_type = entity.Recipe_type.HasValue
                        ...
                        : null,
            Cuisine = cuisine.HasValue
                        ? EnumExtensions.GetEnumMemberValue(cuisine.Value)
                        : null,
